...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <table class="form-control" style="width:100%">
        ...
        <tr>
            <td>
                <asp:CheckBox ID="cbCreateAccount" Text="  Create Account" runat="server" /> </td>
        </tr>
       <tr>
            <td>
  ...
  <br />
    <br />
    <asp:Button ID="btnfinish" runat="server" class="btn-success form-control" Text="Finish Payment and Book service" />
